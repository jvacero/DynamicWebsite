...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/admin_registration.css">
</head>
<body>
    ...
    if (isset($_POST['SUBMIT'])) {
        ...
        if (empty($errors)) {
            ...
            if (mysqli_affected_rows($conn) == 1) {
                // OVERLAPPING MODAL NOTIFICATION (High z-index overlay)
                echo '
                <div class="modal-overlay" id="successModal">
                    <div class="modal-box">
                        <p>REGISTERED SUCCESSFULLY!</p>
                        <a href="admin_dashboard.php" class="modal-btn">CONTINUE TO DASHBOARD</a>
                    </div>
                </div>';
            } else {
